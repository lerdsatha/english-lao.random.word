...
const words = [
    ...
    },
    {
        ...
        description:'able to change or be changed easily according to the situation',
        senten:'My schedule is flexible - I could arrange to meet with you any day next week.',
    ...
    },
    {
...

        {
            ...
            wordlao:'ເພດ',
            description:'either of the two sexes (male and female),',
            senten:'I think all genders are able to care for children equally',
        ...
        {
            word:'stereotype',
            wordlao:'ເປັນສິ່ງທີ່ຄິດເອງໂດຍບໍ່ແມ່ນຄວາມຈິງ(ຜິດ)',
            description:'a set idea that people have about what someone or something is like, especially an idea that is wrong:',
            senten:'The characters in the book are just stereotypes',
